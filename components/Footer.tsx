    ...
    <footer className="bg-white border-t border-zinc-200/60">
      <div className="container mx-auto px-6 md:px-12 py-6">
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <Link 
            href="/" 
            className="text-lg font-black tracking-tighter text-zinc-900 hover:text-zinc-700 transition-colors duration-300 select-none"
            aria-label="Orama Creativ Home"
          >
            ORAMA<span className="text-rose-500">.</span>
          </Link>
